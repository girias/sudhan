...
public class DomParserDemo {
  ...
  public static void main(String[] args) {
    ...
    try {
          ...
          Double price =
              Double.parseDouble(
                  eElement
                      ...
                      .item(0)
                      .getTextContent()); // example String
          customerMap.put(
              cust_name,
              (customerMap.containsKey(cust_name) ? price + customerMap.get(cust_name) : price));
        }
      }
      // Java 7
      ...
      // Java 8
      //         customerMap.keySet().forEach(key -> System.out.println(key + " : " +
      // customerMap.get(key)));
    } catch (Exception e) {
      e.printStackTrace();
    }
