  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      while (scanner.nextLine().equalsIgnoreCase("Yes")) {
        ...
        customerTransactionMap.put(
            custName,
            (customerTransactionMap.containsKey(custName)
                ? price + customerTransactionMap.get(custName)
                : price));
        dateTransactionMap.put(
            invoiceDate,
            (dateTransactionMap.containsKey(invoiceDate)
                ? price + dateTransactionMap.get(invoiceDate)
                : price));
