...
/**
 * Sample Input and output Enter the number of invoices : 4 Enter the invoice 1 details : Raj,Sri
 * nagar,India,52670.00,Not Cleared,Ravi Enter the invoice 2 details : Emi,Kerala,India,52200.00,Not
 * cleared,Shankar Enter the invoice 3 details : Julie,Mexico,USA,52000.69,Cleared,Williams Enter
 * the invoice 4 details : Ram,Delhi,India,52312.20,Not cleared,Sasi Customer details with status
 * cleared Invoices : Name State Country Julie Mexico USA Enter the com.java.example.Invoice creator
 * name : Viji The total invoice value : No invoice available
 */
public class Main {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException {
    ...
    for (int i = 0; i < n; i++) {
      ...
      Invoice invoice =
          new Invoice(
              new User(input[0], input[1], input[2]),
