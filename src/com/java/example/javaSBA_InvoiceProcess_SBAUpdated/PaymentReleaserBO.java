...
public class PaymentReleaserBO extends UserBO {
    ...
    public List<com.java.example.JavaSBA_InvoiceProcess.Invoice> listInvoice() {
        ...
        List<com.java.example.JavaSBA_InvoiceProcess.Invoice> pendInvoices = new ArrayList<com.java.example.JavaSBA_InvoiceProcess.Invoice>();
    ...
    @Override
    public Integer createInvoice(com.java.example.JavaSBA_InvoiceProcess.Invoice invoice) throws com.java.example.JavaSBA_InvoiceProcess.InsufficientPrivilegeException {
        throw new com.java.example.JavaSBA_InvoiceProcess.InsufficientPrivilegeException("Permission Denied");
    }

    @Override
    Boolean updateInvoiceStatus(com.java.example.JavaSBA_InvoiceProcess.Invoice invoice, String status) throws com.java.example.JavaSBA_InvoiceProcess.InsufficientPrivilegeException {
