...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    List<com.java.example.JavaSBA_InvoiceProcess.Invoice> invoiceList =
    ...
    userMenu
        .append("1. Create invoice")
        .append(newLine)
        .append("2. Update invoice")
        .append(newLine)
        .append("3. Invoice Payment")
        .append(newLine)
        .append("4. Logout")
        .append(newLine)
        .append("Enter the choice:");
              ...
              switch (userChoice) {
                case 1:
                  try {
                    ...
                    if (user.getRole().equalsIgnoreCase("Clerk")) {
                      ...
                      com.java.example.JavaSBA_InvoiceProcess.Invoice invoice1 =
                          new com.java.example.JavaSBA_InvoiceProcess.Invoice(
                              0,
                              invoiceInput[0],
                              "Pending",
                              Integer.valueOf(invoiceInput[1]),
                              Date.valueOf(invoiceInput[2]),
                              user);
                      ...
                      throw new com.java.example.JavaSBA_InvoiceProcess
                          .InsufficientPrivilegeException("Permission Denied");
                    }
                ...
                case 3:
                  try {
                    ...
                    com.java.example.JavaSBA_InvoiceProcess.InvoiceDAO invoiceDAO =
                        new InvoiceDAO();
                    List<com.java.example.JavaSBA_InvoiceProcess.Invoice> invoiceListInitial =
                        invoiceDAO.getAllInvoiceList();

                    for (com.java.example.JavaSBA_InvoiceProcess.Invoice invoice1 :
                        invoiceListInitial) {
                    ...
                    if (!invoiceList.isEmpty()) {
                      ...
                      for (com.java.example.JavaSBA_InvoiceProcess.Invoice inv : invoiceList) {
                        if (user.getRole().equalsIgnoreCase("Payment Releaser")
                            && inv.getStatus().equalsIgnoreCase("Approved")) {
                          System.out.format(
                              "%-5s %-15s %-10s %-15s %-15s %s\n",
                              inv.getId(),
                              inv.getInvoiceNumber(),
